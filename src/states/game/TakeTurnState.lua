                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                      ...
                      self.playerPokemon.currentExp = self.playerPokemon.currentExp - self.playerPokemon.expToLevel
                        ...
                        local curHP, curATT, curDEF, curSPED = self.playerPokemon.HP, self.playerPokemon.attack, self.playerPokemon.defense, self.playerPokemon.speed

                        local addHP, addATT, addDEF, addSPED = self.playerPokemon:levelUp()

                        gStateStack:push(BattleMessageState(self.playerPokemon.name .. ' has Leveled up!',
                        function()
